...
\begin{subfigure}{.33\textwidth}
    \centering
    \fbox{\includegraphics[width=0.7\linewidth]{images/results/m/4/mk}}
    \caption[short]{}
\end{subfigure}%
\begin{subfigure}{.33\textwidth}
    \centering
    \fbox{\includegraphics[width=0.7\linewidth]{images/results/m/4/m}}
    \caption[short]{}
\end{subfigure}
\begin{subfigure}{.33\textwidth}
    \centering
...
\begin{subfigure}{.33\textwidth}
    \centering
    \fbox{\includegraphics[width=0.9\linewidth]{images/results/m/5/mk}}
    \caption[short]{}
\end{subfigure}%
\begin{subfigure}{.33\textwidth}
    \centering
    \fbox{\includegraphics[width=0.9\linewidth]{images/results/m/5/m}}
    \caption[short]{}
\end{subfigure}
\begin{subfigure}{.33\textwidth}
    \centering
