...
\end{pseudocode}
\vspace{-8mm}
\captionof{listing}{Kod przedstawiający zmodyfikowany przeze mnie algorytm Helpful-Set 2-partitioning.}
...
Algorytm \ref{code:helpful_sets} przedstawia zmodyfikowaną przeze mnie procedure.
